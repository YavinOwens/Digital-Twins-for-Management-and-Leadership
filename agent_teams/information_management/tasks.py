...
def create_information_management_tasks_with_data(info_governance_agent, metadata_agent, data_quality_agent, compliance_risk_data: str, query: str, conversation_history: Optional[List[Any]] = None) -> List[Task]:
    """
    Create information management tasks with data from previous team.
    ...
    Args:
        ...
        compliance_risk_data: Data from the compliance and risk team
        query: The user's query
        conversation_history: Previous conversation context
        
    Returns:
        List of tasks for the information management team
    """
